...
use TieuMinh\Sumup1\Model\ResourceModel\Post\ImageInformation;
...
class ImageUpload
{
    ...
    public function __construct(
        ...
        $baseTmpPath = 'tieuminh/tmp/image',
        $basePath = 'tieuminh/image',
    ...
    private function getFileInfo()
    {
        if ($this->fileInfo === null) {
            $this->fileInfo = ObjectManager::getInstance()->get(ImageInformation::class);
        }
